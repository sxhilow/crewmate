  ...
  return (
      loading ? (
        ...
        <div className='w-full'>
          ...
          <div className='w-full border border-gray-200 rounded-lg p-6 flex wrap-break-word text-desktop-p shadow-sm'>
        ...
        <div className='w-full leading-relaxed'>
          ...
          <div className='w-full flex flex-wrap border border-gray-200 rounded-lg shadow-sm p-6 gap-2'>
            {
              skills.length > 0 ? (
                skills.map(({label}) => (
